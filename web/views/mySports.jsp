    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#dg').datagrid({
                ...
                url:'${pageContext.request.contextPath}/studentGetSports?studentNumber=${sessionScope.student.studentNumber}',
                columns:[[
...
<table id="dg"></table>
<div id="toolbar">
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-back" plain="true" onclick="unSignSport()">退出报名</a>
</div>
...
<script type="text/javascript">
    ...
    function unSignSport(){
        var row = $('#dg').datagrid('getSelected');
        if (row){
            $('#dlg').dialog('open').dialog('setTitle','待退出报名运动信息');
            $('#fm').form('load',row);
            url = '${pageContext.request.contextPath}/unSignSport?sportId='+row.sportId;
        }
    }
